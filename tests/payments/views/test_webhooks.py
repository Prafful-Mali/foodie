...
class TestWebhookIntegration:
    ...
    def test_webhook_receive_success(self, mock_task, mock_razorpay, api_client):
        ...
        payload = {
            ...
            "payload": {
                "payment": {
                    "entity": {"id": "pay_test456", "order_id": "order_test789"}
                }
            },
        }
...
class TestWebhookProcessingService:
    ...
    def test_process_webhook_authorized(self):
        ...
        webhook = WebhookEventFactory(
            event_id="evt_auth1", event_type="payment.authorized", payload=payload
        )
    ...
    def test_process_webhook_captured(self):
        ...
        subscription = SubscriptionFactory(
            status=SubscriptionStatus.PENDING, tenant__is_premium=False
        )
        payment = PaymentFactory(
            subscription=subscription,
        ...
        webhook = WebhookEventFactory(
            event_id="evt_cap1", event_type="payment.captured", payload=payload
        )
    ...
    def test_process_webhook_failed(self):
        ...
        webhook = WebhookEventFactory(
            event_id="evt_fail1", event_type="payment.failed", payload=payload
        )
